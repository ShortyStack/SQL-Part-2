...
def get_project_by_title(title):
    ...
    row = db_cursor.fetchone()
    # print row[1]
    print "Project: %s described as: %s\n Max grade is: %r" % (row[0], row[1], row[2])
        # SELECT title, description, max_grade
...
def handle_input():
    ...
    #When this file hackbright.py is being run from the command line, then call this code.
    #if name == main is True
